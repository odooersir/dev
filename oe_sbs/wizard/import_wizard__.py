   ...
   # def _generate_import_number(self):
    ...
    def action_import(self):
        ...
        try:
            ...
            print ("register recordddddddddddddddddddddddddddddddddddddddddddddddddddddd")
            # ثبت رکوردها
            ...
            for rec in temp_records:
                ...
                print ("b createeeeeeeeeeeeeeeeeeeeeeeeeeee")
                SBSData.create(rec)
                print ("aa createeeeeeeeeeeeeeeeeeeeeeeeeeee")
                imported_count += 1

            print ("writeeeeeeeeeeeeeeeeeeeeeeeeeee dataaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
